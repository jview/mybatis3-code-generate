...
public class JavaModelGeneratorConfiguration extends PropertyHolder {
    ...
    public XmlElement toXmlElement() {
        ...
        if (exampleTargetPackage != null) {
            answer.addAttribute(new Attribute("exampleTargetPackage", exampleTargetPackage)); //$NON-NLS-1$
        }
        else{
        	 answer.addAttribute(new Attribute("exampleTargetPackage", targetPackage)); //$NON-NLS-1$
        }
